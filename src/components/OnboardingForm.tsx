        ...
        try {
            ...
            const res = await fetch("/api/v1/tenants", {
                ...
                body: JSON.stringify({
                    ...
                    existing_phone_number: form.existing_phone_number ? form.existing_phone_number : undefined
                })
            });
    ...
    if (success) {
        return (
            <div className="text-center p-8 bg-green-50 rounded-2xl border border-green-200">
                ...
                <p className="text-sm text-green-600 mt-4 mb-6">Your assistant is ready! You will receive an email confirmation shortly.</p>
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
                <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Testing / Existing Number (Optional)</label>
                    <input type="text" name="existing_phone_number" value={form.existing_phone_number} onChange={handleChange} className="w-full px-4 py-2 border rounded-xl focus:ring-2 focus:ring-blue-500 outline-none transition" placeholder="Leave blank to buy new, or +614..." />
                </div>
                <div>
